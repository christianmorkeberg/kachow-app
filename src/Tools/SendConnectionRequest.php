...
final class SendConnectionRequest implements Tool
{
    ...
    public function description(): string
    {
        return 'Sends a connection request to another existing user by their email (and emails them a '
            ...
            . 'cycle, workouts_log — "cycle" shares your menstrual cycle status, only if explicitly asked; '
            . '"workouts_log" lets them log workouts for you, a write grant, only if asked). '
            ...
            'properties' => [
                ...
                'share' => [
                    ...
                    'description' => 'What you want to share with them: any of "workouts", "wishlist", '
                        . '"calendar", "cycle", "workouts_log" (lets them log workouts for you).',
                    'items'       => ['type' => 'string'],
                ],
            ],
            'required' => ['email'],
