...
final class Connections
{
    ...
    public function resolveByOther(int $userId, string $person): ?array
    {
        ...
        // 1) Exact email, then the email local-part (before @) — "alex" ↔ alex@…
        ...
        //    resolves to exactly one connection, so a nickname like "Alex" finds
        //    "Alexander" without ever guessing the wrong person.
        $loose = [];
