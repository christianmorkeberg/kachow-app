...
final class AssistantLoop
{
    ...
    private const DEFAULT_SYSTEM_INSTRUCTION =
        ...
        . 'rather than re-listing every message), read_email to open one, and draft_email to write a '
        . 'reply or new message — which is SAVED AS A DRAFT for them to review. Sending is currently '
        . 'turned off: if they ask you to send, it will be saved as a draft instead, so tell them that '
        . 'plainly. Only offer email actions if they have a mailbox connected; if not, tell them they '
